 ...
 * record-holder query into the typed {@see IndividualAgeRecord}
 * DTO. Returns null when either input is missing or the xref can
...
final readonly class IndividualAgeRecordResolver
{
    ...
    /**
     * Materialise the candidate xref against the given tree and
     * wrap it into the DTO together with the picked age. Either
     * `$xref` being null, `$years` being null, or the xref no
     * longer resolving to a live Individual collapses to null.
     */
